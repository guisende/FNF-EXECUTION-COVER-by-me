...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeBar.createFilledBar(0xFF000000, 0xFF9FB5FF);
		...
		add(scoreTxt);
	        ...
	        watermark = new FlxText(scoreTxt.x + -70, scoreTxt.y, 0, "port by guisende", -10000);
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "CHEATER MODE", 32);
